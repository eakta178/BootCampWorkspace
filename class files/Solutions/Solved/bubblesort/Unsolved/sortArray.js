...
var domE1= document.getElementById('start')
domE1.innerHTML=numbers;
...
function sortFunc()
{
  console.log("inside sortfunc");
    var sortedResults=bubbleSort(numbers);

  var domE2 = document.getElementById('result');
  domE2.innerHTML=sortedResults;
